...
class SmsService
{
    ...
    public function notifyDoctor($doctor_name, $address, $number1, $ward){
        ...
        $options1 = [
            'multipart' => [
                ...
                [
                    'name' => 'message',
                    'contents' => "Hurmatli {$doctor_name} sizga yangi bemor keldi. Joylashuv: {$address}, {$ward}-palata"
                ],
                [
                    'name' => 'from',
                    'contents' => '4546'
    ...
    public function notifyDoctorChangeUser($doctor_name, $address, $number1, $ward, $patient){
        $number = preg_replace('/\D/', '', $number1);
        if (strlen($number) == 9) {
            $number = "998".$number;
        }
        ...
        $options1 = [
            'multipart' => [
                ...
                [
                    'name' => 'message',
                    'contents' => "Hurmatli {$doctor_name} sizning {$patient} ismli bemoringiz ko'chirildi. Joylashuv: {$address}, {$ward}-palata"
                ],
                [
                    'name' => 'from',
                    'contents' => '4546'
