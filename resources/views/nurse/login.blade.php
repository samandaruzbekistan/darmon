...
<body>
<div class="container-fluid position-relative bg-white d-flex p-0" style="background-image: url({{ asset('img/nurse-bg.jpg') }}); background-size: cover">
    <!-- Spinner Start -->
        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                    ...
                    <form action="{{ route('nurse_login') }}" method="post">
                        @csrf
